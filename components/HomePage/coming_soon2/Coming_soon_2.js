            ...
            <div className="container mx-auto p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="relative h-64 bg-cover bg-center rounded-lg shadow-lg"
                    ...
                    <div className="ml-5 absolute inset-0 bg-opacity-50 flex flex-col justify-center ">
                        <h2 className="text-textColour  text-2xl font-bold">COMING SOON</h2>
                        <a href="#" className=" text-textColour   font-bold">Shop Now <i
                ...
                >
                    <div className="ml-5 absolute inset-0 bg-opacity-50 flex flex-col justify-center">
                        <h2 className="text-textColour  text-2xl font-bold">COMING SOON</h2>
                        <a href="#" className="text-textColour  font-bold">
